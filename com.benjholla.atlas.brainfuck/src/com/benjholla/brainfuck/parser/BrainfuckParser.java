...
public class BrainfuckParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_instruction_list = 1, RULE_instruction = 2, RULE_loop = 3;
	public static final String[] ruleNames = {
		"program", "instruction_list", "instruction", "loop"
	};
		...
		try {
			...
			((ProgramContext)_localctx).end = match(EOF);
			   	  ...
			   	  if(((ProgramContext)_localctx).instructions.list.isEmpty()){
			   	     ...
			   	     ParserSourceCorrespondence firstInstructionSC = ((ProgramContext)_localctx).instructions.list.get(0).getSourceCorrespondence();
	...
	public static class Instruction_listContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BrainfuckListener ) ((BrainfuckListener)listener).enterInstruction_list(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BrainfuckListener ) ((BrainfuckListener)listener).exitInstruction_list(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BrainfuckVisitor ) return ((BrainfuckVisitor<? extends T>)visitor).visitInstruction_list(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class InstructionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BrainfuckListener ) ((BrainfuckListener)listener).enterInstruction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BrainfuckListener ) ((BrainfuckListener)listener).exitInstruction(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BrainfuckVisitor ) return ((BrainfuckVisitor<? extends T>)visitor).visitInstruction(this);
			else return visitor.visitChildren(this);
		}
	}
		...
		try {
			...
			case TAPE_INCREMENT:
				...
				((InstructionContext)_localctx).tape_increment = match(TAPE_INCREMENT);
				      ...
				      ParserSourceCorrespondence sc = new ParserSourceCorrespondence(file, ((InstructionContext)_localctx).tape_increment.getLine(), ((InstructionContext)_localctx).tape_increment.getStartIndex(), ((InstructionContext)_localctx).tape_increment.getText().length());
			...
			case TAPE_DECREMENT:
				...
				((InstructionContext)_localctx).tape_decrement = match(TAPE_DECREMENT);
				      ...
				      ParserSourceCorrespondence sc = new ParserSourceCorrespondence(file, ((InstructionContext)_localctx).tape_decrement.getLine(), ((InstructionContext)_localctx).tape_decrement.getStartIndex(), ((InstructionContext)_localctx).tape_decrement.getText().length());
			...
			case TAPE_LEFT:
				...
				((InstructionContext)_localctx).tape_left = match(TAPE_LEFT);
				      ...
				      ParserSourceCorrespondence sc = new ParserSourceCorrespondence(file, ((InstructionContext)_localctx).tape_left.getLine(), ((InstructionContext)_localctx).tape_left.getStartIndex(), ((InstructionContext)_localctx).tape_left.getText().length());
			...
			case TAPE_RIGHT:
				...
				((InstructionContext)_localctx).tape_right = match(TAPE_RIGHT);
				      ...
				      ParserSourceCorrespondence sc = new ParserSourceCorrespondence(file, ((InstructionContext)_localctx).tape_right.getLine(), ((InstructionContext)_localctx).tape_right.getStartIndex(), ((InstructionContext)_localctx).tape_right.getText().length());
			...
			case INPUT:
				...
				((InstructionContext)_localctx).input = match(INPUT);
				      ...
				      ParserSourceCorrespondence sc = new ParserSourceCorrespondence(file, ((InstructionContext)_localctx).input.getLine(), ((InstructionContext)_localctx).input.getStartIndex(), ((InstructionContext)_localctx).input.getText().length());
			...
			case OUTPUT:
				...
				((InstructionContext)_localctx).output = match(OUTPUT);
				      ...
				      ParserSourceCorrespondence sc = new ParserSourceCorrespondence(file, ((InstructionContext)_localctx).output.getLine(), ((InstructionContext)_localctx).output.getStartIndex(), ((InstructionContext)_localctx).output.getText().length());
	...
	public final LoopContext loop() throws RecognitionException {
		...
		try {
			...
			((LoopContext)_localctx).rbrace = match(T__1);
			   	  ...
			   	  long length = ((LoopContext)_localctx).rbrace.getStartIndex() - ((LoopContext)_localctx).lbrace.getStartIndex();
			   	  ParserSourceCorrespondence sc = new ParserSourceCorrespondence(file, ((LoopContext)_localctx).lbrace.getLine(), ((LoopContext)_localctx).lbrace.getStartIndex(), length);
