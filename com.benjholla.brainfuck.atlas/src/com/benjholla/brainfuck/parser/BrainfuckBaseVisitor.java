...
public class BrainfuckBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements BrainfuckVisitor<T> {
	 ...
	 */
	@Override
	public T visitProgram(BrainfuckParser.ProgramContext ctx) {
	 ...
	 */
	@Override
	public T visitInstruction_list(BrainfuckParser.Instruction_listContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitInstruction(BrainfuckParser.InstructionContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitLoop(BrainfuckParser.LoopContext ctx) {
		return visitChildren(ctx);
	}
}